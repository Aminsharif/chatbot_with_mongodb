...
class Settings(BaseSettings):
    ...
    base_model_name: str = Field(default="groq/compound", description="Base model name to use")
    
    # MongoDB Configuration
    mongo_uri: str = Field(default="mongodb+srv://mongodb:s4Nlrns35MYiM896@cluster0.kcu5ueu.mongodb.net/?appName=Cluster0", 
